      ...
      <StyledNavbar>
        <Container fluid>
          <div className="w-100 d-flex justify-content-end pe-4">
            <Logo src="/mascle_website/images/usc-shield.png" alt="USC Shield" size="60px" />
          </div>
        </Container>
      </StyledNavbar>
          ...
          <Row className="w-100 m-0">
            ...
            <LeftSection xs={12} lg="auto">
              <Navbar.Brand as={Link} to="/" className="d-flex align-items-center">
                <Logo src="/mascle_website/images/usc-viterbi-logo1.jpg" alt="USC Viterbi Logo" />
                <div
                  className="mx-2 mx-lg-3 bg-secondary opacity-25"
                  style={{ width: '1px', height: '50px' }}
                />
                <MascleLogo src="/mascle_website/images/mascle_logo2.png" alt="USC Machine Learning Center (MaSCle)" />
              </Navbar.Brand>
            </LeftSection>
